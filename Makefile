...
FREERTOS_DIR_REL      := $(FREERTOS_DIR_ENV)/FreeRTOS
FREERTOS_DIR          := $(abspath ${FREERTOS_DIR_REL})

FREERTOS_PLUS_DIR_REL := $(FREERTOS_DIR_ENV)/FreeRTOS-Plus
FREERTOS_PLUS_DIR     := $(abspath ${FREERTOS_PLUS_DIR_REL})

KERNEL_DIR            := $(FREERTOS_KERNEL_DIR_ENV)

PROJ_SRC_DIR_REL	  := ./source
PROJ_SRC_DIR		  := $(abspath ${PROJ_SRC_DIR_REL})

CLI_DIR			  	  := ${PROJ_SRC_DIR}/CLI

INCLUDE_DIRS          += -I.
INCLUDE_DIRS          += -I./include
INCLUDE_DIRS          += -I${CLI_DIR}
...
SOURCE_FILES          := $(wildcard ${PROJ_SRC_DIR}/*.c)
SOURCE_FILES          += $(wildcard ${KERNEL_DIR}/*.c)
SOURCE_FILES		  += $(wildcard ${CLI_DIR}/*.c)
